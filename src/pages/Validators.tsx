      ...
      <div className="flex items-center justify-between mt-8">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Counts include super-validators and parties that have not yet collected a round. The Statistics page only
            shows non-SV validators with at least one recorded round.
          </p>
        </div>
      </div>
