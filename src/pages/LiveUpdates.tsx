                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="space-y-2 flex-1 min-w-0">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        {update.migration_id && (
                          <Badge variant="secondary">Migration #{update.migration_id}</Badge>
                        )}
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-xs text-muted-foreground">
                        {update.workflow_id && (
                          <div className="flex items-center gap-1 min-w-0">
                            ...
                            <span className="truncate" title={update.workflow_id}>Workflow: {update.workflow_id}</span>
                          </div>
                        )}
                        {update.synchronizer_id && (
                          <div className="flex items-center gap-1 min-w-0">
                            <Activity className="w-3 h-3 flex-shrink-0" />
                            <span className="truncate" title={update.synchronizer_id}>Sync: {update.synchronizer_id}</span>
                          </div>
                        )}
                        {update.record_time && (
