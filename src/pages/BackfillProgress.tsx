        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              {lastActivity || "Waiting for activity..."}
            </p>
          </div>
        ...
        {lastActivity && (
          <div className="flex items-center justify-between px-4 py-2 bg-primary/5 border border-primary/20 rounded-lg text-sm">
            ...
            <span className="text-muted-foreground">
              {activityLog.length > 0 && formatDistanceToNow(new Date(activityLog[activityLog.length - 1].timestamp), { addSuffix: true })}
            </span>
          </div>
        )}
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="font-mono text-sm truncate">
                          {log.type === 'cursor_update' ? (
                            ...
                            <>
                              <Badge variant="secondary" className="mr-2 bg-blue-500/10 text-blue-400 border-blue-500/20">
                                Update
                              </Badge>
                              {log.updateId}
                            </>
                            ...
                            <>
                              <Badge variant="secondary" className="mr-2 bg-green-500/10 text-green-400 border-green-500/20">
                                Event
                              </Badge>
                              {log.eventId}
                            </>
