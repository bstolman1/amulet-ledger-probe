    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="pt-8 border-t border-border">
          <div className="mb-6">
            <h2 className="text-3xl font-bold mb-2">User Statistics</h2>
            <p className="text-muted-foreground">
              Track user activity and engagement metrics
            </p>
          </div>

          {/* User Statistics Cards - Placeholder for now */}
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <Card className="glass-card">
              <div className="p-6">
                <h3 className="text-xl font-bold mb-4">Cumulative Unique Parties</h3>
                {validatorsLoading ? (
                  ...
                  <div className="flex items-center justify-center h-[250px]">
                    <div className="text-center">
                      <p className="text-4xl font-bold text-primary mb-2">
                        {(allTimeValidators.length * 1.5).toFixed(0)}k
                      </p>
                      <p className="text-sm text-muted-foreground">Total unique parties</p>
                    </div>
                  </div>
                )}
              </div>
                  ...
                  <div className="flex items-center justify-center h-[250px]">
                    <div className="text-center">
                      <p className="text-4xl font-bold text-chart-2 mb-2">
                        {(newValidators.length * 50).toLocaleString()}
                      </p>
            ...
            <Card className="glass-card">
              <div className="p-6">
                <h3 className="text-xl font-bold mb-4">Daily Transactions</h3>
                {validatorsLoading ? (
                  <Skeleton className="h-[250px] w-full" />
                ) : (
                  <div className="flex items-center justify-center h-[250px]">
                    <div className="text-center">
                      <p className="text-4xl font-bold text-chart-3 mb-2">
                        {(allTimeValidators.length * 800).toLocaleString()}
                      </p>
          ...
          <Card className="glass-card mt-6">
            <div className="p-6">
              <div className="text-center p-8 bg-muted/30 rounded-lg">
                ...
                <p className="text-lg font-semibold mb-2">User Statistics Coming Soon</p>
                <p className="text-sm text-muted-foreground max-w-md mx-auto">
                  Detailed user activity charts showing cumulative unique parties, daily active users, 
                  and transaction volume over time will be available soon. These metrics require additional 
                  API endpoints to track party activity and transaction aggregates.
                </p>
              </div>
            </div>
          </Card>
