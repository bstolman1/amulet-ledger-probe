...
const Elections = () => {
  ...
  const electionsQuery = useRealtimeAggregatedTemplateData(
  ...
  const paginatedData = filteredElections.slice(
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">
            DSO governance election requests and voting data
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Card className="glass-card p-6">
            ...
            {electionsQuery.isLoading ? (
              ...
              <p className="text-3xl font-bold text-primary">
                {elections.length.toLocaleString()}
              </p>
            )}
          </Card>
          ...
          <Card className="glass-card p-6">
            ...
            {electionsQuery.isLoading ? (
              ...
              <p className="text-3xl font-bold text-primary">
                {filteredElections.length.toLocaleString()}
              </p>
            )}
          </Card>
        </div>
