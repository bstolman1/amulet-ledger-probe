/**
 * Upload ACS Snapshot to Supabase via Edge Function
 * 
 * Reads the snapshot files generated by snapshot-script.js and uploads them to Supabase.
 * 
...
const SUPABASE_URL = process.env.SUPABASE_URL || 'https://mbbjmxubfeaudnhxmwqf.supabase.co';
const SUPABASE_ANON_KEY = process.env.SUPABASE_ANON_KEY || 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1iYmpteHViZmVhdWRuaHhtd3FmIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTk5NzMxOTMsImV4cCI6MjA3NTU0OTE5M30.yc9pYrMnctKubAetS97p01cT99d0w07GaLJ4k0iiHUc';
